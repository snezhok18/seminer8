...
// Console.Write("Bведите количество строк 1 массива: ");
// int rowsA = int.Parse(Console.ReadLine()!);
// Console.Write("Введите количество столбцов 1 массива: ");
// int columnsA = int.Parse(Console.ReadLine()!);
// Console.Write("Bведите количество строк 2 массива: ");
...
// int[,] A = GetArray(columnsA, rowsA);
// PrintArray(A);

// int[,] B = GetArray(rowsB, columnsB);
// PrintArray(B);

// PrintArray(MultMatrix(A, B));
...
// // --- Метод нахождения прщизведения двух матриц ---
